...
public class AudioPlayer {
            ...
            case AudioManager.RINGER_MODE_NORMAL:
                ...
                try {
                    mPlayer.setDataSource(mContext,
                            Uri.parse("android.resource://" + mContext.getPackageName() + "/" + R.raw.incoming_call));
                    mPlayer.prepare();
                } catch (IOException e) {
    ...
    private static AudioTrack createProgressTone(Context context) throws IOException {
        AssetFileDescriptor fd = context.getResources().openRawResourceFd(R.raw.incoming_call);
